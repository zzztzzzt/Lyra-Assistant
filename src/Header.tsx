    ...
    <div>
      ...
      <div className="xl:max-w-375 xl:mx-auto xl:flex xl:flex-row xl:justify-between xl:items-center">
        <div className="mx-auto h-50 w-full max-w-120 grid grid-cols-3 px-6 gap-6">
          ...
          >
            <div className="fill-current w-full h-auto">
              <svg role="img" viewBox="0 0 135 135" fill="currentColor"><path d="M49.9885 63.7582C40.0228 53.1091 29.2764 30.4937 29.2764 30.4937C29.2764 30.4937 32.582 62.7613 41.3619 76.0783C49.6752 88.6876 61.4253 86.3596 71.2849 97.0306C81.0278 107.575 91.4324 130 91.4324 130C91.4324 130 88.4623 97.9468 79.9115 84.7106C71.6924 71.9878 59.9051 74.355 49.9885 63.7582Z"/><path d="M47.0158 63.7582C37.0502 53.1091 26.3037 30.4937 26.3037 30.4937C26.3037 30.4937 29.6094 62.7613 38.3892 76.0783C46.7025 88.6876 58.4526 86.3596 68.3122 97.0306C78.0552 107.575 88.4597 130 88.4597 130C88.4597 130 85.4896 97.9468 76.9389 84.7106C68.7198 71.9878 56.9325 74.355 47.0158 63.7582Z"/><path d="M68.3069 47.7256C62.7979 39.2753 58.1943 22.5806 58.1943 22.5806C58.1943 22.5806 56.5705 44.956 60.9514 55.0811C65.0994 64.6681 73.3823 64.4937 78.8164 72.9462C84.1862 81.2986 88.5798 97.8225 88.5798 97.8225C88.5798 97.8225 90.4064 75.6332 86.1719 65.5907C82.1017 55.9377 73.7887 56.1344 68.3069 47.7256Z"/><path d="M97.6155 30.0409C100.193 23.9979 101.258 12.7695 101.258 12.7695C101.258 12.7695 104.83 26.9372 103.165 33.9267C101.589 40.5448 96.2566 41.3696 93.7271 47.4055C91.2277 53.3699 90.2784 64.465 90.2784 64.465C90.2784 64.465 86.5974 50.4397 88.1776 43.5197C89.6965 36.868 95.0505 36.0541 97.6155 30.0409Z"/><path d="M80.2134 21.6839C80.573 15.0455 77.6992 4 77.6992 4C77.6992 4 85.9993 16.2358 86.8354 23.4583C87.627 30.2969 82.842 32.9268 82.5258 39.5417C82.2133 46.0784 85.1507 56.9572 85.1507 56.9572C85.1507 56.9572 76.7962 44.8946 75.9038 37.7674C75.046 30.9167 79.8555 28.2896 80.2134 21.6839Z"/></svg>
            </div>
          </div>
